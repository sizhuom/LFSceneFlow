...
if ~isempty(this.segMap)
    pyramid_weight = compute_segweight_pyramid(this.segMap,this.segSigma,this.xyr,this.pyramid_levels,1/this.pyramid_spacing);
else
    % pyramid_xyweight = compute_xyweight_pyramid(this.xyflow,this.xyweightSigma,this.xyr,smooth_sigma,this.pyramid_levels,1/this.pyramid_spacing);
    pyramid_weight = compute_xyweight_pyramid2(this.xyflow,this.xyweightSigma,this.xyr,this.pyramid_levels,1/this.pyramid_spacing);
end
...
gnc_pyramid_masks = compute_mask_pyramid(this.mask,this.gnc_pyramid_levels,1/this.gnc_pyramid_spacing);
if ~isempty(this.segMap)
    gnc_pyramid_weight = compute_segweight_pyramid(this.segMap,this.segSigma,this.xyr,this.gnc_pyramid_levels,1/this.gnc_pyramid_spacing);
else
    % gnc_pyramid_xyweight = compute_xyweight_pyramid(this.xyflow,this.xyweightSigma,this.xyr,smooth_sigma,this.gnc_pyramid_levels,1/this.gnc_pyramid_spacing);
    gnc_pyramid_weight = compute_xyweight_pyramid2(this.xyflow,this.xyweightSigma,this.xyr,this.gnc_pyramid_levels,1/this.gnc_pyramid_spacing);
