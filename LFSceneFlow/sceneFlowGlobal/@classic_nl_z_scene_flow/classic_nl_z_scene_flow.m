function this = classic_nl_z_scene_flow(varargin)
%
...
narginchk(0, 1);
  ...
  switch (length(varargin))
    case 0
      ...
      this = class(this, 'classic_nl_z_scene_flow');         
      
    case 1
      if isa(varargin{1}, 'classic_nl_z_scene_flow')
        this = varargin{1};        
      else    
          this = classic_nl_z_scene_flow;
