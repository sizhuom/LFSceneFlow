function opo = denoise_color_weighted_medfilt2_2d(op, im, occ, bfhsz, mfsz, sigma_i, fullVersion)
...
if nargin < 5
    ...
    opo(:,:,1) = medfilt2(op(:,:,1), mfsz, 'symmetric');
    opo(:,:,2) = medfilt2(op(:,:,2), mfsz, 'symmetric');
end;
...
pad_o  = padarray(op(:,:,1), bfhsz*[1 1], 'symmetric', 'both');        
pad_p  = padarray(op(:,:,2), bfhsz*[1 1], 'symmetric', 'both');     
