function runCLGReal( workDir,logFileName,frameNo0,frameNo1,c,param,initFlow,gtFlow)
%RUNCLGReal Run CLG on real data
...
[lf0, H] = gcReadSubImages(fullfile(workDir, listing(frameNo0).name));
...
lf1 = gcReadSubImages(fullfile(workDir, listing(frameNo1).name));
