...
if this.use_bs
    It = partial_deriv_bs(this.images, this.bs_images, this.intr, op_pad, ...
        this.interpolation_method);
else
    It  = partial_deriv(this.images, this.intr, op_pad, this.interpolation_method, this.deriv_filter_xy, this.deriv_filter_uv,...
