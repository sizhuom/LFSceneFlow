...
if ~isempty(this.xyflow)
    ...
    pyramid_weight = compute_xyweight_pyramid3(this.xyflow,this.xyweightSigma,this.xyr,this.pyramid_levels,1/this.pyramid_spacing);
else
...
if ~isempty(this.xyflow)
    ...
    gnc_pyramid_weight = compute_xyweight_pyramid3(this.xyflow,this.xyweightSigma,this.xyr,this.gnc_pyramid_levels,1/this.gnc_pyramid_spacing);
else
