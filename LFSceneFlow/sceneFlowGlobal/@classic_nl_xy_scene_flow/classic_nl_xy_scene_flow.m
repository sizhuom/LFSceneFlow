function this = classic_nl_xy_scene_flow(varargin)
%
...
narginchk(0, 1);
  ...
  switch (length(varargin))
    case 0
      ...
      this.useCLG           = false; % combined local-global
      this.sigmaTS          = [4 4 2 2]; % structure tensor smoothing
      ...
      this = class(this, 'classic_nl_xy_scene_flow');         
      
    case 1
      if isa(varargin{1}, 'classic_nl_xy_scene_flow')
        this = varargin{1};        
      else    
          this = classic_nl_xy_scene_flow;
