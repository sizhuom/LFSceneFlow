function [ L, a, b ] = LFRGB2Lab( R, G, B )
%LFRGB2LAB Adpated from RGB2LAB, convert a LF from RGB to CIELAB
% function [L, a, b] = RGB2Lab(R, G, B)
% function [L, a, b] = RGB2Lab(I)
% function I = RGB2Lab(...)
%
% RGB2Lab takes red, green, and blue matrices, or a single K x L x M x N x 3 image, 
...
L = reshape(YT .* (116 * Y3 - 16.0) + (~YT) .* (903.3 * Y), k, l, m, n);
a = reshape(500 * (fX - fY), k, l, m, n);
b = reshape(200 * (fY - fZ), k, l, m, n);
